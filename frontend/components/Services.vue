<template>
  <div>
        ...
        <div class="grid md:grid-cols-2 gap-8">
          ...
          <AnimatedSection class="relative rounded-3xl overflow-hidden shadow-2xl group">
            ...
            <div class="relative z-20 p-10 h-full flex flex-col items-start text-white">
              ...
              <button class="w-full sm:w-auto bg-white text-slate-900 hover:bg-blue-600 hover:text-white px-8 py-3 rounded-xl font-bold transition-all">
                Inscribir mi Auto →
              </button>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection :delay="200" class="relative rounded-3xl overflow-hidden shadow-2xl group">
            ...
            <div class="relative z-20 p-10 h-full flex flex-col items-start text-white">
              ...
              <button class="w-full sm:w-auto bg-white text-blue-600 hover:bg-slate-100 px-8 py-3 rounded-xl font-bold transition-all">
    ...
    <section id="inspeccion" class="py-24 bg-slate-50 overflow-hidden">
      <div class="container mx-auto px-4">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
          <AnimatedSection>
            ...
            <div class="space-y-6">
              <div v-for="feature in inspectionFeatures" :key="feature.title" class="flex gap-4">
                ...
                <div>
                  <h4 class="text-xl font-bold text-slate-900">{{ feature.title }}</h4>
          ...
          <AnimatedSection :delay="300" class="relative">
            ...
            <div class="absolute -bottom-6 -left-6 z-20 bg-white p-6 rounded-2xl shadow-xl max-w-xs animate-bounce-slow">
              ...
              <p class="text-slate-700 font-medium italic">"Me salvó de comprar un auto con el motor malo. Valió cada peso."</p>
              <p class="text-slate-400 text-sm mt-2 font-bold">— Carlos M., Santiago</p>
            </div>
          </AnimatedSection>
        </div>
      </div>
